...
#
${TD}/bin/onedep_request --summary_content_type "report-summary-example-test"  ${X_ARGS}
#
#
...
${TD}/bin/onedep_request --output_file  report-summary-example-test-${TS}.json  --output_type "report-summary-example-test" ${X_ARGS}
#
